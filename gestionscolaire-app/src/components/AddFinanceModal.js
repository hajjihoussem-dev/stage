...
export class AddFinanceModal extends Component{

    constructor(props){
    
        super(props);
        this.state= {fins:[], snackbaropen:false, snackbarmsg:''};
        ...
        return(
          ...
          <Modal.Body>
               ...
               <Row>
                 ...
                 {this.state.fins.map(fin => 
                    <option  key={fin.ID}>{fin.Identifiant}</option>)}
                 </Form.Control>
                 </Form.Group>
